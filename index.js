...
function create_message(commands) {
  ...
  let result = `<button class=\"uv-message-button\" data-message=\"${command}\">${button_text}</button>\n`;
  console.log(result);
  return result;
}
...
function create_toggle(commands) {
  ...
  let result = `<button class=\"uv-toggle-off\" data-message-on=\"${command1}\" data-message-off=\"${command2}\">${button_text}</button>\n`;
  console.log(result);
